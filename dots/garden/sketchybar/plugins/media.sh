...
if [ "$STATE" = "playing" ]; then
  ...
  sketchybar --set $NAME label="$MEDIA" padding_left=8 padding_right=8 \
             ...
             --set appmedia label="$APP" icon="󰐌" background.color=$BCOLOR padding_left=8 padding_right=8 background.corner_radius=6 background.border_width=0 background.height=24 \
